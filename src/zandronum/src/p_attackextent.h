...
// per-actor override (HitRadius/HitHeight) wins, otherwise fall back to the actor's physical
...
// [MGOOOOOO] Effective vertical attack extent. Like ComputeAttackExtent, a positive HitHeight
...
// factor. It never inflates the override (a taller-than-default actor keeps its full HitHeight),
