...
enum ActorFlag7
{
	...
	MF7_FLYCHEAT		= 0x00080000,	// must be part of the actor so that it can be tracked properly
...
// interaction info
	...
	// [MGOOOOOO] Scales a custom HitHeight by the crouch shrink (current height vs default height),
