...
make_app_bundle() {
    ...
    [[ -f "$macos/zandronum.pk3" ]] || die "zandronum.pk3 missing from $BUILD_DIR -- the pk3 target didn't run. Build the 'pk3' target or use tools/build-run.sh; refusing to ship a bundle the engine can't start."
