...
failed. Proving the registry round trip needs a reachable address — a forwarded port or a real
server — otherwise report LAN and registry-query separately rather than claiming the whole loop.
